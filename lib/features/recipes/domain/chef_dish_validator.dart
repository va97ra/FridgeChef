...
ChefDishValidationResult validateChefDish({
  ...
  switch (family) {
    ...
    case ChefDishFamily.svekolnikColdSoup:
      ...
      requireCanonical(
          'яйцо', 'Свекольнику нужно яйцо для классической структуры.');
    ...
    case ChefDishFamily.buckwheatRusticBowl:
      requireCanonical(
          'гречка', 'Гречка по-домашнему требует гречневую основу.');
      requireAnyCanonical(
        ['грибы', 'лук', 'морковь'],
    ...
    case ChefDishFamily.sauerkrautPreserve:
      _validateSauerkrautPreserveTechnique(
        violations: violations,
        steps: normalizedSteps,
      );
      requireCanonical(
        'капуста',
        'Квашеной капусте нужна капустная основа, а не случайная овощная смесь.',
      );
      requireCanonical(
        'соль',
        'Квашеной капусте нужна соль для правильной ферментации.',
      );
      forbidAnyCanonical(
        ['майонез', 'сметана', 'сыр', 'яйцо', 'колбаса', 'сосиски'],
        'Квашеная капуста не должна уходить в салат с заправкой или горячий гарнир.',
      );
      forbidAnyStep(
        ['уксус', 'маринуй', 'обжарь', 'сковород', 'запекай'],
        'Квашеная капуста не должна превращаться в быстрый уксусный маринад или горячее блюдо.',
      );
      break;
    case ChefDishFamily.lightlySaltedCucumbers:
      _validateLightlySaltedCucumbersTechnique(
        violations: violations,
        steps: normalizedSteps,
      );
      requireCanonical(
        'огурец',
        'Малосольным огурцам нужны целые огурцы как основа.',
      );
      requireCanonical(
        'соль',
        'Малосольным огурцам нужна соль для правильного рассола.',
      );
      requireCanonical(
        'укроп',
        'Малосольным огурцам нужен укроп для классического аромата.',
      );
      requireCanonical(
        'чеснок',
        'Малосольным огурцам нужен чеснок для правильного пряного профиля.',
      );
      forbidAnyCanonical(
        ['майонез', 'сметана', 'сыр', 'яйцо', 'томатная паста'],
        'Малосольные огурцы не должны превращаться в обычный салат или горячую закуску.',
      );
      forbidAnyStep(
        ['уксус', 'маринуй', 'обжарь', 'сковород', 'заправь'],
        'Малосольные огурцы не должны уходить в уксусный маринад, жарку или салатную заправку.',
      );
      break;
    case ChefDishFamily.berryJam:
      _validateBerryJamTechnique(
        violations: violations,
        steps: normalizedSteps,
      );
      requireAnyCanonical(
        ...
        'Варенью нужна явная ягодная база, а не абстрактная сладкая масса.',
      );
      requireCanonical(
        'сахар',
        'Варенью нужен сахар, чтобы ягоды дали сок и собрались в густой сироп.',
      );
      forbidAnyCanonical(
        [
          'крахмал',
        ...
        'Ягодное варенье не должно уходить в кисель, молочный десерт или savoury-заготовку.',
      );
      forbidAnyStep(
        [
          'процеди',
          'процеж',
          'разведи крахмал',
          'крахмал в холодной воде',
          'блендером',
        ],
        'Варенье не должно уходить в процеженный напиток, кисель или пюре-соус.',
      );
      break;
    case ChefDishFamily.charlotte:
      _validateCharlotteTechnique(
        violations: violations,
        steps: normalizedSteps,
      );
      requireCanonical('яблоко', 'Шарлотке нужна яблочная фруктовая основа.');
      requireCanonical('яйцо', 'Шарлотке нужна яичная бисквитная связка.');
      requireCanonical('мука', 'Шарлотке нужна мука для бисквитного теста.');
      requireCanonical(
        'сахар',
        'Шарлотке нужна сахарная сладость для яблочного бисквита.',
      );
      requireAnyStep(
        ['запекай', 'духовк'],
        'Шарлотка должна выпекаться в духовке.',
      );
      requireAnyStep(
        ['взбей яйца с сахаром', 'пышную массу', 'светлую пышную массу'],
        'Шарлотке нужно взбить яйца с сахаром до пышной массы.',
      );
      requireAnyStep(
        ['разложи яблоки в форме', 'яблоки в форме', 'вылей тесто на яблоки'],
        'Шарлотке нужно уложить яблоки в форму и залить их бисквитным тестом.',
      );
      forbidAnyCanonical(
        ['сыр', 'майонез', 'чеснок', 'лук', 'печень', 'капуста', 'картофель'],
        'Шарлотка не должна уходить в savory-запеканку или несладкий пирог.',
      );
      forbidAnyStep(
        ['сковород', 'обжарь', 'раскатай', 'защипни края'],
    ...
    case ChefDishFamily.mors:
      ...
      break;
    case ChefDishFamily.kissel:
      _validateKisselTechnique(
        violations: violations,
        steps: normalizedSteps,
      );
      requireAnyCanonical(
        ...
        'Киселю нужна явная ягодная база, иначе он превращается в безликий сладкий напиток.',
      );
      requireCanonical(
        'сахар',
        'Киселю нужна сладость, чтобы собрать ягодную кислоту и не дать вкусу стать пустым.',
      );
      requireCanonical(
        'крахмал',
      ...
      forbidAnyCanonical(
        ...
        'Ягодный кисель не должен уходить в молочный десерт, соус или savoury-вариант.',
      );
      forbidAnyStep(
        ['блендером с молоком', 'запекай', 'обжарь', 'котлет'],
        'Кисель не должен превращаться в молочный коктейль, запеканку или любое горячее savory-блюдо.',
      );
      break;
    ...
    case ChefDishFamily.liverFritters:
      ...
      _validateLiverFritterTechnique(
        violations: violations,
        steps: normalizedSteps,
      );
      requireCanonical('печень', 'Печеночным оладьям нужна печеночная основа.');
      requireCanonical(
        'лук',
        'Печеночным оладьям нужен лук для правильной домашней глубины.',
      );
      requireCanonical('яйцо', 'Печеночным оладьям нужно яйцо для связки.');
      requireCanonical(
          'мука', 'Печеночным оладьям нужна мука для удержания массы.');
      requireAnyStep(
        ['ложкой', 'небольшими порциями'],
        'Печеночные оладьи должны выкладываться ложкой небольшими порциями.',
      );
      requireAnyStep(
        ['2-3 минуты с каждой стороны'],
        'Печеночные оладьи должны быстро жариться с двух сторон.',
      );
      forbidAnyCanonical(
        ['сахар', 'корица'],
        'Печеночные оладьи не должны уходить в сладкий профиль.',
      );
      forbidAnyStep(
        ['шайбы', 'влажными руками', 'сформируй котлеты'],
        'Печеночные оладьи не должны формоваться как сырники или котлеты.',
      );
      forbidAnyStep(
        ['духовк', 'запекай'],
        'Печеночные оладьи не должны уходить в запекание.',
      );
      break;
    case ChefDishFamily.liverCake:
      _validateLiverCakeTechnique(
        violations: violations,
        steps: normalizedSteps,
      );
      requireCanonical('печень', 'Печеночному торту нужна печеночная основа.');
      requireCanonical(
        'яйцо',
        'Печеночному торту нужны яйца для печеночных коржей.',
      );
      requireCanonical(
        'мука',
        'Печеночному торту нужна мука, чтобы тонкие коржи держали форму.',
      );
      requireCanonical(
        'лук',
        'Печеночному торту нужна луковая овощная прослойка.',
      );
      requireCanonical(
        'морковь',
        'Печеночному торту нужна морковная овощная прослойка.',
      );
      requireAnyCanonical(
        ['майонез', 'сметана'],
        'Печеночному торту нужна мягкая майонезная или сметанная прослойка.',
      );
      requireAnyStep(
        ['слоями', 'собери печеночный торт', 'каждый корж'],
        'Печеночный торт должен собираться слоями, а не подаваться россыпью.',
      );
      requireAnyStep(
        ['в холодильник', 'убери в холод', 'подавай холодным'],
        'Печеночный торт должен настояться в холоде перед подачей.',
      );
      forbidAnyCanonical(
        ['сахар', 'корица'],
        'Печеночный торт не должен уходить в сладкий профиль.',
      );
      forbidAnyStep(
        ['духовк', 'запекай', 'вылей в форму'],
        'Печеночный торт не должен превращаться в одну запеченную массу.',
      );
      forbidAnyStep(
        ['подавай горячим', 'сразу подавай горячим'],
    ...
    case ChefDishFamily.stewedCabbageStew:
      ...
      final hasCabbageStewCue = _stepsContainAny(
          ...
          (_stepsContainAny(normalizedSteps, ['капуст']) &&
              _stepsContainAny(
                  normalizedSteps, ['под крышкой', '20-25 минут']));
...
void _validateKisselTechnique({
  required List<String> violations,
  required List<String> steps,
}) {
  if (!_stepsContainAny(
      steps, ['разомни', 'раздав', 'прогрей ягоды', 'ягодную основу'])) {
    violations.add(
      'Киселю нужна отдельно собранная ягодная основа, а не просто сладкая вода с добавками.',
    );
  }
  if (!_stepsContainAny(steps, [
    'залей водой',
    'залей ягодную основу водой',
    'ягодный отвар',
    'прогрей основу'
  ])) {
    violations.add(
      'Киселю нужна ягодная основа на воде, которую сначала спокойно прогревают.',
    );
  }
  if (!_stepsContainAny(steps, ['процеди', 'процеж'])) {
    violations.add(
      'Ягодную основу для киселя нужно процедить, чтобы густота была мягкой, а не грубой.',
    );
  }
  if (!_stepsContainAny(steps,
      ['разведи крахмал', 'крахмал в холодной воде', 'холодной водой'])) {
    violations.add(
      'Киселю нужно отдельно развести крахмал холодной водой, иначе пойдут комки.',
    );
  }
  if (!_stepsContainAny(
      steps, ['тонкой струйкой', 'помешивая', 'постоянно помешивая'])) {
    violations.add(
      'Крахмал в кисель вводят тонкой струйкой и при помешивании, чтобы текстура была ровной.',
    );
  }
  if (!_stepsContainAny(
      steps, ['загуст', 'мягкой густоты', 'слегка густ', 'вязк'])) {
    violations.add(
      'Кисель должен дойти до мягкой густоты, а не остаться жидким как морс.',
    );
  }
  if (!_stepsContainAny(steps, [
    'подавай тёплым',
    ...
    violations.add(
      'Киселю нужен осознанный режим подачи: тёплый густой напиток или охлаждённый ягодный десерт.',
    );
  }
  if (_stepsContainAny(steps,
      ['бурно кипяти', 'кипяти 10 минут после крахмала', 'сильном огне'])) {
    violations.add(
      'Кисель нельзя долго и агрессивно кипятить после крахмала, иначе густота ломается.',
    );
  }
}

void _validateBerryJamTechnique({
  required List<String> violations,
  required List<String> steps,
}) {
  if (!_stepsContainAny(steps, ['засыпь', 'дали сок', 'собственный сок'])) {
    violations.add(
      'Варенью нужно сначала засыпать ягоды сахаром и дать им пустить сок.',
    );
  }
  if (!_stepsContainAny(
    steps,
    ['слабый огонь', 'слабом огне', 'растворится', 'снимай пену'],
  )) {
    violations.add(
      'Варенье должно спокойно прогреваться на слабом огне, чтобы сахар растворился без грубого кипения.',
    );
  }
  if (!_stepsContainAny(
    steps,
    ['густого сиропа', 'капля держалась', 'капля держится', 'увар'],
  )) {
    violations.add(
      'Варенью нужно увариться до густого сиропа, а не остаться жидкой ягодной водой.',
    );
  }
  if (!_stepsContainAny(steps, ['банкам', 'контейнер', 'остуди', 'в холод'])) {
    violations.add(
      'Варенье нужно остудить и убрать в банку или контейнер, а не подавать сразу как горячий напиток.',
    );
  }
  final explicitlyNoWater = _stepsContainAny(
    steps,
    ['без добавления воды', 'не добавляя воды'],
  );
  final hasAddedWaterStep = steps.any(
    (step) =>
        (step.contains('залей') ||
            step.contains('влей') ||
            step.contains('добавь воду')) &&
        step.contains('вод'),
  );
  if (!explicitlyNoWater && hasAddedWaterStep) {
    violations.add(
  ...
  if (_stepsContainAny(
    steps,
    ['бурно кипяти', 'сильном огне', 'кипяти 15 минут'],
  )) {
    violations.add(
      'Варенье нельзя агрессивно кипятить, иначе вкус станет плоским и компотным.',
    );
  }
}
...
void _validateLiverFritterTechnique({
  required List<String> violations,
  required List<String> steps,
}) {
  if (!_stepsContainAny(steps, [
  ...
  if (!_stepsContainAny(steps, ['с луком', 'лук'])) {
    violations.add(
      'Печеночную массу нужно собирать вместе с луком, иначе вкус выйдет плоским.',
    );
  }
  if (!_stepsContainAny(steps, ['густую печеночную массу', 'держала форму'])) {
    violations.add(
      'Печеночным оладьям нужна ложечная густая масса, а не жидкая печеночная смесь.',
    );
  }
}

void _validateLiverCakeTechnique({
  required List<String> violations,
  required List<String> steps,
}) {
  if (!_stepsContainAny(steps, [
    'пробей',
    'гладкое печеночное тесто',
    'печеночные коржи',
    'блендер',
  ])) {
    violations.add(
  ...
  if (!_stepsContainAny(steps, [
    'тонкие печеночные коржи',
    'тонким слоем',
    '1-2 минуты с каждой стороны',
  ])) {
    violations.add(
      'Печеночный торт требует тонкие отдельно обжаренные печеночные коржи.',
    );
  }
  if (!_stepsContainAny(steps, [
    'овощную прослойку',
    'обжарь овощную прослойку',
    'мелко нарежь',
  ])) {
    violations.add(
      'Печеночному торту нужна отдельно подготовленная овощная прослойка.',
    );
  }
  if (!_stepsContainAny(steps, ['остуди', 'каждый корж отдельно остуди'])) {
    violations.add(
      'Перед сборкой печеночные коржи нужно остудить, иначе слои поплывут.',
    );
  }
}

void _validateSauerkrautPreserveTechnique({
  required List<String> violations,
  required List<String> steps,
}) {
  if (!_stepsContainAny(
    steps,
    ['перетри капусту', 'капуста не даст сок', 'пока она не даст сок'],
  )) {
    violations.add(
      'Квашеной капусте нужно перетереть капусту с солью до собственного сока.',
    );
  }
  if (!_stepsContainAny(
    steps,
    ['утрамбуй', 'под соком', 'прижми так'],
  )) {
    violations.add(
  ...
  if (!_stepsContainAny(steps, ['прокалывай', 'выпуская газ'])) {
    violations.add(
      'Квашеную капусту нужно прокалывать во время ферментации, выпуская газ.',
    );
  }
  if (!_stepsContainAny(steps, ['в холод', 'подавай холодной'])) {
    violations.add(
      'После ферментации квашеную капусту нужно убрать в холод и подавать холодной.',
    );
  }
}

void _validateLightlySaltedCucumbersTechnique({
  required List<String> violations,
  required List<String> steps,
}) {
  if (!_stepsContainAny(
    steps,
    ['срежь кончики', 'кончики у огурцов'],
  )) {
    violations.add(
      'Малосольным огурцам нужно подготовить огурцы и срезать кончики перед засолкой.',
    );
  }
  if (!_stepsContainAny(
    steps,
    ['залей огурцы рассолом', 'рассолом', 'полностью покрыты'],
  )) {
    violations.add(
  ...
  if (!_stepsContainAny(
    steps,
    ['8-12 часов', 'на ночь', 'при комнатной температуре'],
  )) {
    violations.add(
      'Малосольным огурцам нужно постоять 8-12 часов или ночь до просаливания.',
    );
  }
  if (!_stepsContainAny(
    steps,
    ['в холод минимум', 'убери малосольные огурцы в холод', 'охлажден'],
  )) {
    violations.add(
      'После засолки малосольные огурцы нужно охладить перед подачей.',
    );
  }
}

void _validateCharlotteTechnique({
  required List<String> violations,
  required List<String> steps,
}) {
  if (!_stepsContainAny(
    steps,
    ['взбей яйца', 'пышную массу', 'светлую пышную массу'],
  )) {
    violations.add(
  ...
  if (!_stepsContainAny(
    steps,
    ['аккуратно вмешай муку', 'вмешай муку лопаткой', 'воздушным'],
  )) {
    violations.add(
      'Шарлотке нужно аккуратно вмешать муку, чтобы бисквит не осел.',
    );
  }
  if (!_stepsContainAny(
    steps,
  ...
  if (!_stepsContainAny(
    steps,
    ['30-35 минут', '35-40 минут', 'золотистой корочки', 'подъёма'],
  )) {
    violations.add(
      'Шарлотку нужно допечь до подъёма и золотистой корочки, а не просто прогреть.',
    );
  }
  if (!_stepsContainAny(steps, ['10 минут', 'постоять', 'перед нарезкой'])) {
    violations.add(
      'Шарлотке нужен короткий отдых после духовки, чтобы мякиш стабилизировался.',
    );
  }
}

...
const chefBlueprints = <ChefBlueprint>[
  ...
  ChefBlueprint(
    ...
    titleStyle: ChefTitleStyle.anchorWithFocus,
    stepStyle: ChefStepStyle.porridge,
    family: ChefDishFamily.porridge,
    slots: [
      ChefSlot(
        key: 'grain',
        candidates: ['рис'],
  ...
  ChefBlueprint(
    ...
    titlePrefix: 'Голубцы классические',
    description:
        'Классические голубцы, где капустные листья держат мясо-рисовую начинку и спокойно доходят в мягком томатно-сметанном соусе.',
    timeMin: 52,
    servingsBase: 4,
    tags: ['russian_classic', 'generated_local'],
    anchorSlot: 'protein',
    ...
    family: ChefDishFamily.classicGolubtsy,
    slots: [
      ChefSlot(
        key: 'protein',
        candidates: ['фарш'],
      ...
      ChefSlot(
        key: 'sauce',
        candidates: ['томатная паста', 'сметана'],
        minCount: 1,
        maxCount: 2,
      ),
    ],

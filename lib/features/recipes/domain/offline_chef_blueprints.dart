...
const chefBlueprints = <ChefBlueprint>[
  ...
  ChefBlueprint(
    id: 'pea_smoked_soup',
    profile: DishProfile.soup,
    titlePrefix: 'Гороховый суп с копченостями',
    description:
        'Русский гороховый суп, где горох долго томится до мягкости, а копчёная мясная основа, лук и морковь собирают густой домашний бульон.',
    timeMin: 46,
    servingsBase: 3,
    tags: ['russian_classic', 'generated_local'],
    anchorSlot: 'base',
    secondaryAnchorSlot: 'smoked',
    supportSlot: 'veg',
    preferredStarters: ['соль', 'перец', 'лавровый лист', 'укроп'],
    maxImplicitPantryStarters: 4,
    titleStyle: ChefTitleStyle.anchorWithFocus,
    stepStyle: ChefStepStyle.soup,
  ...
  ChefBlueprint(
    id: 'mushroom_soup',
    profile: DishProfile.soup,
    titlePrefix: 'Грибной суп домашний',
    description:
        'Русский домашний грибной суп, где грибы сначала прогреваются с луком, а картофель и мягкий сметанный или укропный финиш удерживают бульон собранным.',
    timeMin: 34,
    servingsBase: 3,
    tags: ['russian_classic', 'generated_local'],
    anchorSlot: 'base',
    secondaryAnchorSlot: 'root',

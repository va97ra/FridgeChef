...
Закрыто новое семейство: `charlotte`

Что добавлено:

- новый `ChefDishFamily.charlotte`
- отдельный blueprint для шарлотки
- отдельная генерация шагов для яблочной бисквитной выпечки в engine
- отдельная валидация яблочной бисквитной структуры и anti-drift checks
- отдельное family-specific reasoning в `chef_rules`, чтобы шарлотка не тянула savory bake support
- покрытие в roadmap как `covered`
- позитивные и негативные тесты

Смысл семейства:

- это не generic sweet bake и не яблочный пирог на раскатанном тесте
- это яблочная шарлотка с пышной яично-сахарной бисквитной основой
- обязательны яблоки, яйца, мука и сахар
- яблоки должны отдельно укладываться в форму, а тесто должно заливать фруктовый слой
- мука должна вмешиваться аккуратно, чтобы мякиш не стал тяжелым
- нужна духовочная выпечка до подъема и золотистой корочки
- нужен короткий отдых перед нарезкой
- блюдо не должно уходить в savory bake, сковородную жарку или закрытый пирог
...
- вынести отдельное preserve modeling и после него закрывать `sauerkraut_preserve`
